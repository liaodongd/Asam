...
//        System.out.println("0: (x:250, y:270),font:25.5");
...
//        type= "1";
    ...
    private static void addText(File file, String ztName, String type, String
        ...
        BaseFont bf = BaseFont.createFont("Times-Roman",
            "Cp1252", BaseFont.NOT_EMBEDDED); // set font
        //baseFont不支持字体样式设定.但是font字体要求操作系统支持此字体会带来移植问题.
        Font font = new Font(bf, 11.5f);
        ...
        for (int i = 1; i <= reader.getNumberOfPages(); i++) {
            ...
            over.beginText();
            //设置字体和大小
            over.setFontAndSize(font.getBaseFont(), 11.5f);
            //设置字体颜色
            ...
            image.setAbsolutePosition(Float.valueOf(310), Float.valueOf(580));
            over.addImage(image);
